...
var Clock = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Clock, [{
    ...
    value: function updateClockHandObj(o, value, degree, startAngle, angle) {
      ...
      o = (0, _reactAddonsUpdate["default"])(o, {
        value: {
          $set: value
        },
        degree: {
    ...
    value: function onKeyDown(e) {
      ...
      if (!isNaN(newValue) && refName != 'meridiem') {
        ...
        elObj = (0, _reactAddonsUpdate["default"])(elObj, {
          value: {
            $set: newValue
          },
          degree: {
    ...
    value: function handleMouseUp() {
      ...
      if (clockHandSecond.isDragging || clockHandMinute.isDragging || clockHandHour.isDragging) {
        ...
        clockHandSecond = (0, _reactAddonsUpdate["default"])(clockHandSecond, {
          isDragging: {
            $set: false
          },
          angle: {
        ...
        clockHandMinute = (0, _reactAddonsUpdate["default"])(clockHandMinute, {
          isDragging: {
            $set: false
          },
          angle: {
        ...
        clockHandHour = (0, _reactAddonsUpdate["default"])(clockHandHour, {
          isDragging: {
            $set: false
          },
          angle: {
